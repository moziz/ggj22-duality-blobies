...
std::unique_ptr<sf::Shader> Resources::getShader(ShaderResourceName name) const
{
    ...
    case ShaderResourceName::mapVis:
        success = shader->loadFromFile(
            ...
            //getResourcePath("assets/shader/lelu_sdf.glsl"),
            //getResourcePath("assets/shader/fps_sdf.glsl"),
            //getResourcePath("assets/shader/doom_sdf.glsl"),
            //getResourcePath("assets/shader/sextic.glsl"),
            //getResourcePath("assets/shader/mandelbulb.glsl"),
