...
export const CatIcon = ({color}: {color: string}) => (
    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cat"
         className="svg-inline--fa fa-cat fa-w-16" role="img"
...
export const DinoIcon = ({color}: {color: string}) => (
    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="dragon"
         className="svg-inline--fa fa-dragon fa-w-20" role="img"
